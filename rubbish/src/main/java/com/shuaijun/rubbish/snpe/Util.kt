...
class YuvToRgbConverter(context: Context) {
    ...
    @Synchronized
    fun yuvToRgb(inputImage: ImageProxy, outputBitmap: Bitmap) {

        // Ensure that the intermediate output byte buffer is allocated
        if (!::yuvBuffer.isInitialized) {
            pixelCount = inputImage.cropRect.width() * inputImage.cropRect.height()
        ...
        imageToByteArray(inputImage, yuvBuffer)
