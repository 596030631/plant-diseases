...
//import com.shuaijun.plant.databinding.DialogResultBinding
...
//    private lateinit var dialogView: DialogResultBinding
//
...
//
//
//        dialogView = DialogResultBinding.inflate(LayoutInflater.from(requireContext()))
...
//            val op = ImageCapture.OutputFileOptions
//                .Builder(file)
//                .build()
...
//                    resultDialog.show()
//                    dialogView.aiResult.text = imgDataList[position].info
//                    dialogView.imgBig.setImageDrawable(Drawable.createFromPath(imgDataList[position].path))
//                    dialogView.root.setOnClickListener {
//                        resultDialog.dismiss()
//                        mainModel.setFullscreen(requireActivity().window, false, false)
//                    }
//                }
//            },
//            { parent ->
...
//        mainModel.setFullscreen(requireActivity().window, true, false)
//
//    }
//
