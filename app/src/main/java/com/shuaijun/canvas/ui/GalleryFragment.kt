...
import com.shuaijun.canvas.BuildConfig
import com.shuaijun.canvas.R
import com.shuaijun.canvas.databinding.FragmentGalleryBinding
import com.shuaijun.canvas.util.showImmersive
import java.io.File
import java.util.*
...
class GalleryFragment internal constructor() : Fragment() {
    ...
    ): View = FragmentGalleryBinding.inflate(inflater, container, false).also { binding = it }.root
...
//        }
        ...
        binding.reportButton.setOnClickListener {
            Navigation.findNavController(it)
                .navigate(GalleryFragmentDirections.actionGalleryFragmentToReportFragment())
        }
